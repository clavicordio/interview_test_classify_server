...
class ClassificationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Classify = channel.unary_unary(
                ...
                request_serializer=classification__pb2.B64Image.SerializeToString,
...
def add_ClassificationServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Classify': grpc.unary_unary_rpc_method_handler(
                    servicer.Classify,
                    request_deserializer=classification__pb2.B64Image.FromString,
...
class Classification(object):
    ...
    def Classify(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Classification/Classify',
            classification__pb2.B64Image.SerializeToString,
